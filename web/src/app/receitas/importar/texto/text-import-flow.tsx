  ...
  return (
    <section className="mx-auto max-w-5xl px-5 pb-24 sm:px-8">
      <form action={action} className="rounded-[2rem_2rem_4.5rem_2rem] bg-[#FFFCF6] p-6 shadow-[0_10px_0_#E6DED2] sm:p-8">
        <label htmlFor="source-text" className="font-serif text-2xl font-black">Texto da receita</label>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[#746D64]">Podes colar uma receita de uma mensagem, publicação, livro digital ou site. Nada será guardado como receita sem veres primeiro o preview.</p>
        ...
        <details className="mt-4 rounded-2xl bg-[#F8F4EC] px-4 py-3 text-sm text-[#6F6860]">
          ...
          <p className="mt-3 leading-6">Mantém os títulos “Ingredientes” e “Preparação”. Podes usar grupos como “Base:” e “Recheio:”. Frações, intervalos e medidas como cups, oz, g ou ml são reconhecidos.</p>
        </details>
